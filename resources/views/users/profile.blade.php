...
<br>
<br>    
<h3 class="title has-text-centered">ACCOUNT SUSPENDED</h3>
<p class="subtitle has-text-centered">{{$user->first_name}} {{$user->last_name}}'s account has been suspended due to violation of Terms and Conditions</p>
@else
    @if($user->activated)
    <div class="container">
        <div class="columns is-gapless">
            ...
            <section class="hero is-medium" style="background:url({{$user->banner}}); background-size:cover">
                ...
                <h2 class="subtitle" style="color:#fff">&nbsp;&nbsp; {{$user->location}}</h2>
                </div>
            </section>
            <br>
